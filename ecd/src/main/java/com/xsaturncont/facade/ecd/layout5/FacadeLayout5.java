package com.xsaturncont.facade.ecd.layout5;
...
import com.xsaturncont.facade.ecd.layout5.bloco0.Create0000;
import com.xsaturncont.facade.ecd.layout5.bloco9.Create9900;
import com.xsaturncont.facade.ecd.layout5.bloco9.Create9999;
import com.xsaturncont.layout5ecd._9001;
import com.xsaturncont.layout5ecd._Raiz;
import com.xsaturncont.util.Util;

public class FacadeLayout5 {
	...
	public FacadeLayout5(Connection connection, String codigoEmpresa, String ano) {
		this.connection = connection;
		this.codigoEmpresa = codigoEmpresa;
		this.ano = ano;
	}

	public void build() throws SQLException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, ParseException,
		...
		// _Raiz.get_0000().get_K990().setQtd_lin_k(getTotalBloco("_K",
		// recordTotal));
