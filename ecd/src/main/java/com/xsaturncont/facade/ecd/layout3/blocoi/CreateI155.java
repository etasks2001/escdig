...
import com.xsaturncont.layout3ecd._I155;
...
public class CreateI155 {
	...
	public List<_I155> get() throws SQLException {
		...
		PreparedStatement ps = connection
				.prepareStatement("select d.conta, sum(case d.natureza when 'D' then d.valor else 0 end) D, sum(case d.natureza when 'C' then d.valor else 0 end) C from diario d where d.codigoempresa = "
						+ this.codigoEmpresa + " and d.ano = 14 and d.mes = " + mes + " group by d.conta order by conta");
