...
public class CreateI150SaldoInicial {
	...
	PreparedStatement ps = connection.prepareStatement(
		"select pl.conta conta, pl.valorabertura saldoinicial from planoconta pl where pl.codigoempresa = " + codigoEmpresa + " and pl.ano = 20 and pl.tipoconta = \'A\' order by pl.conta");
