...
public class CreateI150SaldoInicial {
	public Map<String, Double> getSaldoInicial(Connection connection, String codigoEmpresa) throws SQLException {
		...
		PreparedStatement ps = connection.prepareStatement(
				"select pl.conta conta, pl.valorabertura saldoinicial from planoconta pl where pl.codigoempresa = "
						+ codigoEmpresa + " and pl.ano = 19 and pl.tipoconta = \'A\' order by pl.conta");
