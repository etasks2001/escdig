...
import com.xsaturncont.layout3ecd._J930;
...
public class CreateJ930 {
	...
	public List<_J930> get() throws SQLException {
		...
		PreparedStatement ps = connection.prepareStatement("select resplegal,docresplegal,cargoresplegal,profcontabil,crc from empresa where codigo = " + codigoEmpresa);
		...
		_J930.setIdent_cpf("03018020847");
