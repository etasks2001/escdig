...
import com.xsaturncont.facade.ecd.layout6.bloco9.Create9001;
import com.xsaturncont.facade.ecd.layout6.bloco9.Create9990;
import com.xsaturncont.facade.ecd.layout6.blocoi.CreateI001;
import com.xsaturncont.facade.ecd.layout6.blocoi.CreateI990;
import com.xsaturncont.facade.ecd.layout6.blocoj.CreateJ001;
import com.xsaturncont.facade.ecd.layout6.blocoj.CreateJ990;
import com.xsaturncont.layout6ecd._0000;
...
public class Create0000 {
	...
	public _0000 get() throws SQLException, ParseException, IOException, NoSuchAlgorithmException {
		PreparedStatement ps = connection
				.prepareStatement("select nome,cnpj,uf,ie from empresa where codigo = " + codigoEmpresa);
		...
		_0000.setReg("0000");
		_0000.setLecd("LECD");
		_0000.setDt_ini("01012019");
		_0000.setDt_fin("31122019");
		...
		_0000.setIdent_mf("N");
		_0000.setInd_esc_cons("N");
		_0000.setInd_centralizada("0");
		_0000.setInd_mudanc_pc("0");
		_0000.setCod_plan_ref("2");
