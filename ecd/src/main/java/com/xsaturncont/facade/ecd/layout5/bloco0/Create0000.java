package com.xsaturncont.facade.ecd.layout5.bloco0;
...
import com.xsaturncont.facade.ecd.layout5.bloco9.Create9001;
import com.xsaturncont.facade.ecd.layout5.bloco9.Create9990;
import com.xsaturncont.facade.ecd.layout5.blocoi.CreateI001;
import com.xsaturncont.facade.ecd.layout5.blocoi.CreateI990;
import com.xsaturncont.facade.ecd.layout5.blocoj.CreateJ001;
import com.xsaturncont.facade.ecd.layout5.blocoj.CreateJ990;
import com.xsaturncont.layout5ecd._0000;
...
public class Create0000 {
	...
	public _0000 get() throws SQLException, ParseException, IOException, NoSuchAlgorithmException {
		...
		_0000.setReg("0000");
		_0000.setLecd("LECD");
		_0000.setDt_ini("01012016");
		_0000.setDt_fin("31122016");
