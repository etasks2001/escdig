...
import com.xsaturncont.layout5ecd._I050;
	...
	public List<_I050> get() throws SQLException, IOException {
		...
		PreparedStatement ps = connection
				.prepareStatement("select conta, tipoconta,descricao from planoconta where codigoempresa = "
						+ this.codigoEmpresa
						+ " and ano = 16 and conta not in(\'9999999999\',\'2404000000\',\'2105140001\',\'3202010000\',\'3202010001\',\'3202010002\') and conta not like '13%' order by conta");
