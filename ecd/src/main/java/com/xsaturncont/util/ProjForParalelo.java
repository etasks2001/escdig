...
public class ProjForParalelo {
	...
	public static void main(String[] args) {
		 ...
		 * t1.start();
		 * 
		 * for(int i=0;i<5000;i++) { // total = total + SomaValor(i);
		 * soma_parcial[i] = SomaValor(i);
		 * 
		 * }
		 * 
		 * 
		 * for(int i=0;i<5000;i++) total = total + soma_parcial[i];
		 * 
		 * t1.stop();
		 * 
		 * System.out.println("Total Soma:" + String.valueOf(total));
		 * 
		 * System.out.println("Leitura de arquivos. Abordagem sequencial. Tempo:"
		 * + t1.getElapsed());
		 * 
		 * 
		 * // Paralelo 1
		 ...
		 * t1.start();
		 * 
		 * Loop.withIndex(0, 5000, new Loop.Each() { public void run(int i) {
		 * 
		 * soma_parcial[i] = SomaValor(i); } });
		 * 
		 * Loop.withIndex(0, 5000, new Loop.Each() { public void run(int i) {
		 ...
		 * System.out.println("Total Soma:" + String.valueOf(total));
		 * 
		 * System.out.println("Leitura de arquivos. Abordagem paralela. Tempo:"
		 * + t1.getElapsed());
		 */
		// Testes de gravação
		 ...
		 * t1.start();
		 * 
		 * for(int i=0;i<5000;i++) { ProjForParalelo.GravaValor(i,total); }
		 * 
		 * t1.stop();
		 * 
		 * System.out.println("Gravação de arquivos. Abordagem sequencial. Tempo:"
		 * + t1.getElapsed());
		 * 
		 * // Paralelo
		 * 
		 ...
		 * t1.stop();
		 * 
		 * System.out.println("Gravação de arquivos. Abordagem paralela. Tempo:"
		 * + t1.getElapsed());
		 */
	...
	static float SomaValor(int i) {
		...
		try {
			...
			br = new BufferedReader(new FileReader("C:/Users/mauro/Documents/f_" + String.valueOf(i) + ".txt"));
	...
	static void GravaValor(int i, Float valor) {
		...
		try {
			...
			File file = new File("C:/Users/mauro/Documents/f_" + String.valueOf(i) + ".txt");
