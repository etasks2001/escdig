...
public class _1920 {
    ...
    private java.util.List<_1921> _1921;
    @com.xsaturncont.annotation.FieldDetail(number = 15)
    private java.util.List<_1925> _1925;
    @com.xsaturncont.annotation.FieldDetail(number = 16)
    private java.util.List<_1926> _1926;
    ...
    public java.util.List<_1921> get_1921() {
        return _1921;
    }

    public java.util.List<_1925> get_1925() {
        return _1925;
    }

    public java.util.List<_1926> get_1926() {
        return _1926;
    }
    ...
    public void set_1921(java.util.List<_1921> _1921) {
        this._1921 = _1921;
    }

    public void set_1925(java.util.List<_1925> _1925) {
        this._1925 = _1925;
    }

    public void set_1926(java.util.List<_1926> _1926) {
        this._1926 = _1926;
    }
