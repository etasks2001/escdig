...
@WebServlet("/balancoGravarNumeroOrdem")
public class BalancoGravarNumeroOrdem extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public BalancoGravarNumeroOrdem() {
	super();
    }
	...
	try {
	    ...
	    ps = connection.prepareStatement("update J100 set nu_ordem=? where sk=?");
