...
@WebServlet("/dlpaDmplGravarNumeroOrdem")
public class DlpaDmplGravarNumeroOrdem extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DlpaDmplGravarNumeroOrdem() {
	super();
    }
	...
	try {
	    ...
	    ps = connection.prepareStatement("update J210 set nu_ordem=? where sk=?");
