...
public class DRELinha {
    ...
    public DRELinha(int sk, int ano, int codigoempresa, int nu_ordem, String cod_agl, String ind_cod_agl, int nivel_agl, String cod_agl_sup, String descr_cod_agl, double vl_cta_ini,
	    String ind_dc_cta_ini, double vl_cta_fin, String ind_dc_cta_fin, String ind_grp_dre) {
	super();
	this.sk = sk;
	this.ano = ano;
